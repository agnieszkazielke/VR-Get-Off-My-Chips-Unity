...
public class SeagullCameraScript : MonoBehaviour {
    public GameObject target;
    public GameObject seagullCamera;
    ...
    void Update()
    {
        ...
        seagullCamera.transform.localPosition = new Vector3(0f, cameraDistance, -2f * cameraDistance);
    }
